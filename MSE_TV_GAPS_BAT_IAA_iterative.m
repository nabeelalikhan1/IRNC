...
% for N_S=5:5:15
    ...
    for k1=1:NS
        ...
        for kkkkk=0:4
            ...
            elseif kkkkk==3
                                  [ext_sig_iaa,findex] = FAST_IF_Recover_bat_iterative(Sig,121, num+2, 10,100,0.1,0,NA);
            ...
            elseif kkkkk==3
                    mse_FAST_IF_IAA_iterative(k1)=mean(abs(ext_sig_iaa-SigO));
    ...
    mse_IAA(iiii)=mean(mse_FAST_IF_IAA)
        mse_IAA_it(iiii)=mean(mse_FAST_IF_IAA_iterative)
 ...
 plot(10:10:40,mse_IAA_it(1:4),'k','linewidth',3);
hold on;
plot(10:10:40,mse_IAA(1:4),'b','linewidth',3);
hold on;
plot(10:10:40,mse_ST(1:4),'r','linewidth',3);
hold on;
plot(10:10:40,mse_TF(1:4),'g:','linewidth',3);
hold on;
plot(10:10:40,mse_GDD(1:4),'y','linewidth',3);

xlabel('Number of missing samples in each gap')
ylabel('Mean absolute errror')
legend('IRNC-iterative','IRNC','Modified OMP','TF filtering','Gradient Descent');
set(gca,'fontsize', 36)
%  
%  mse_IAA =
% 
